...
Copper is  currently not a trendy  nutrient to supplement
...
The question of supplementation has to be within the context
of a specific overall intake and other factors like genetics.
Even if a surplus occurs in one location, the question
remains if there  would be 
a net benefit reducing deficiency in one place even if 
more excess occurs elsewhere.  
...
\mjmtol{ its also worth noting that other sources may 
be significant as with water and air exposure \cite{Georgopoulos_Wang_Georgopoulos_Assessment_human_exposure_2006} }
...
but clearly that was not the major determinant of copper content
.
...
excess even though both may be matters of degree and context. 
 Deficiency   in commercial dog foods was    suspected years
earlier  \cite{HuberTLa}
while works as early as 2000 suggest supplementation
...
Low copper status is  known in humans and is
 associated with liver problems 
too, some related to high fructose intake \cite{PMID7825519}. 
...
the bottleneck in the copper supply.
...
Its also noteworthy that CTR1 transport is reduced if some
histidines are mutated in either the C or N terminal tails. 
One concern in thiw work relates to "high-infidelity transcription"
due to limitations of specific amino acids including histidine. 
...
to defects in excretion as a bigger concern than intake.
...
.  Note this work also suggests copper deficiency
