...
and nature of the experimental work, this paper is organized
with a long redundant introduction to motivate an interest in the
relatively simple dog feeding chronology and observtions of outcomes.
The discussion is short just to tie these specific results back
to the larger confusing body of knowledge. 
...
\mjmguide{ The overall diet may be a source of resolution  }

\mjmresolve

\mjmguide{ Copper interactions with dietary sulfur in other animals    }
...
would seem important for diseases that are common in dogs.
