...
.
Indeed  case of simple copper deficiency with no obvious
...
accumulation.  
Its also worth noting that cross-effects have been observed
with amino acids and in particular tryptophan. Copper deficient
rats appeared to metabolise tryptophan loads differently
and excrete amino acids but only taurine was found in the urine
of copper sufficient animals  ( repeated ref )
...
\begin{abstract}
Copper is known to perform roles important for diverse processes
...
GI tract health. Copper had been observed to destroy both
vitamins and anti-vitamins suggesting a need to minimize contact
with separate feedings, time release formulations, or perhaps
supplements such as copper citrate.  
...
in the elderly.
Specific dietary components may %be of particular interest
...
the supremacy of cause and effect over trying to treat numbers. 
