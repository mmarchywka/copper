...
\newcommand{\mjmaddbio}{mjm_tr,releases,../casesum/casesum}
%\newcommand{\mjmversion}{0.00}
%\newcommand{\mjmtrno}{MJM-2024-010}
...
of supplements for dogs with diverse genetics and conditions
...
or chaperone copper compounds. The combination
...
\cite{PMID6110524}
Copper dosing with dogs of unknown background may raise some very real cause for
concern and deficiency has not been considered a
problem \cite{doi:10.1177/104063870001200201} although suspected years
earlier in commercial foods \cite{HuberTLa} and
 low copper is  associated with liver problems related to high fructose( including increased heaptic iron )  \cite{PMID7825519}
and fat diets in other species \cite{PMC5167165} .
