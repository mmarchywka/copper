...
\newcommand{\mjmaddbio}{mjm_tr,releases,potusebib,../casesum/casesum}
%\newcommand{\mjmversion}{0.00}
%\newcommand{\mjmtrno}{MJM-2024-010}
...
Copper in dog food has become a concern  over the past few years
...
Copper dosing of  dogs of unknown background may raise some very 
real cause for
concern 
as a variety of copper handling genetic diseases are common
\cite{PMC6531654}


. Deficiency has not been considered a
problem by some authors circa 2000  \cite{doi:10.1177/104063870001200201}.


One study provided a histogram of Cu content (ppm dry weight )
...
\cite{Thornburg_Rottinghaus_McGowan_Hepatic_Copper_Concentrations_1990}.
 ...
 Deficiency however wss  suspected years
earlier in commercial foods \cite{HuberTLa} and
 low copper is  associated with liver problems related to 
high fructose( including increased heaptic iron )  \cite{PMID7825519}
and high fat diets in other species \cite{PMC5167165}.


However, popular beliefs often turn out to be wrong and
there is good reason to believe that is the case with
copper. 
This work describes inclusion of copper into a set
of supplements for dogs with different conditions and unknown genetics 
showing generally beneficial results with added copper.
...
in that supplementation improves apparent health.
...
While some association between intake and hepatic copper
content was shown in a small study
\cite{Fieten_HooijerNouwens_Biourge_Association_Dietary_Copper_2012},
factors other than intake may effect local copper
concentrations in nominally normal genetics. 
...
peroxide formation and potentially free copper both conditions
...
However, senescent cells may accumulate copper in the absence
of autophagy
\cite{Masaldan_Clatworthy_Gamell_Copper_accumulation_senescent_2018}.
Copper elevation may commit cells to differentiation 
i cord-blood derived cells \cite{PMID11849228}
and it may be regulat4ed during myogenic differntiation
\cite{PMC5824686} rasiing the ossibility that accumulation
...
a putiative confounding factor. 


 We tried to set a hard upper limit of
3mg/kg body weight of supplemental copper per day based on some quoted NOAEL's but the
original source from  1972 discussed in \cite{NAP9782}.

All of the dogs currently living here received increased copper
shortly after the arrival of Trixie due to apparent
spread of coughing. Trixies was later treated with Clavamox
leading to cure sugesting indeed an infectious cause existed. 
...
Brownie  & 21-01-12 21-02-14&pregnant, fibroids, heartworm &50 &1.5-2.5&& uneventful  \\
...
copper and vitamin K \cite{mmarchywka-MJM-2021-003-v0.50rg}
. Other conidtions indluce heartworm
...
2023-02-22. Prior to her diganosis, she was oberved to 
...
As many features could be rationalized as related to thyroid output,
...
are known \cite{PMC5133110} and other apparent deficiencies could be a consequence of
insufficient B-6 alone \cite{PMID7814236}\cite{PMID18564178}\cite{Guilarte1989}.
% sled dog exercize comment omitted for no good reason to include

Deficiencies are not always correctable by simply eating more of something- for example,
calcium intake alone may not fix osteoporosis.
Distribution may be a concern as it is possible to have both
too much and too little in differing locations due to defects
not with absorption but rather handling proteins that would transport
or chaperone copper compounds. 
...
and in particular rings such as in tyorinse. Speciation gradients
...
Zinc absorption has been shown to depend on salt type and
gastric pH 
\cite{PMID8577018}.
...
Iron intake in ruminant feed has also been observed to decrease
copper uptake
