...
distribution.
The question of supplementation then would be if there is
a net benefit reducing deficiency in one place even if 
more exvess occurs elsewhere until the bottleneck can be found. 
...
In cases where pathological copper content exists,
a better strategy is to find the processing bottleneck
than be concerned with intake alone. 
...
and in particular rings such as in tyorinse. 
