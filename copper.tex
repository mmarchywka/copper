...
could be identified and manipulated somewhat with overall dietary composition.
...
but copper intake  was probably not the major determinant of copper content
.
...
Sulfate reducing bacteria may contribute to confusing metabolism
...
high fructose intake \cite{PMID7825519}  although
sulfur containing amino acids do not appear to be generally
...
are considered as a group of conditions
...
\cite{PMC5746443}.
A variety of causes are know in humans
\cite{PMC4948224}.
...
Heart problems are common in dogs. Recently, DCM 
has made headlines as an increasing threat. While it is
...
while suggesting copper  is "routinely supplemented" 
\cite{PMC7447921}. While expressing
...
therapeutric effect. 
This may also be another case where an early low pH step
prvents the formation of insoluble products creating 
varied outcomes idiosyncartic to particular diets
suggesting those with impaired stomach acid such as the elderly
...
One common issue is jumping to hypothesis testing
...
Because of the nature of the biological role of copper, related literature,
and the novel  experimental work, this paper is organized
with a long redundant introduction to motivate an interest in the topic.
The novel results are relatively simple dog feeding chronology 
and observtions of outcomes.
The discussion is short just to tie these specific results back
to the existing  body of knowledge that introduced the topic. 
...
interpretation is also included here, instead of the
discussion section. 
...
symptoms expectedd of taurine defieincy.
